...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  void initState() {
    ...
    config.DefaultLocation? dLocation = Provider.of<SplashController>(
      context,
      listen: false,
    ).configModel?.defaultLocation;
    _defaut = LatLng(
      double.parse(dLocation?.lat ?? '0'),
    ...
    if (widget.isEnableUpdate && widget.address != null) {
      ...
      if (Provider.of<ProfileController>(
            context,
            listen: false,
          ).userInfoModel !=
          null) {
            ...
            Consumer<AddressController>(
              builder: (context, addressController, child) {
                if (Provider.of<SplashController>(
                          context,
                          listen: false,
                        ).configModel!.deliveryCountryRestriction ==
                        1 &&
                          ...
                          children: [
                            ...
                            Consumer<AuthController>(
                              builder: (context, authProvider, _) {
                                print(
                                  'LAT: ${locationController.position.latitude}, LNG: ${locationController.position.longitude}',
                                );
                            ...
                            ElevatedButton(
                              onPressed: () {
                                ...
                                print(
                                  'BUTTON CLICK - LAT: ${Provider.of<LocationController>(context, listen: false).position.latitude}, '
                                  'LNG: ${Provider.of<LocationController>(context, listen: false).position.longitude}',
                                );
                              },
                                    ...
                                    children: [
                                      GoogleMap(
                                        ...
                                        onMapCreated:
                                          ...
                                          print(
                                            'MAP CREATED - LAT: ${locationController.position.latitude}, '
                                            'LNG: ${locationController.position.longitude}',
                                          );
